from study.SimpleTransformer.b_load_data_warmup import MyDatasets, get_dataloader
import config
...
import os
from utils import set_seed, warmup_opt, plot_loss_curve, plot_lr_curve
...
scheduler = warmup_opt(optimizer, num_warmup_epochs=config.WARMUP, init_lr=1e-4, target_lr=config.LR)
